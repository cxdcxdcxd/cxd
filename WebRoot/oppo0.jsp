...
<html>
  ...
  <div class="show">
    ...
    <c:if test="${empty sessionScope.user}">
          <a href="login0.html"><img src="images/cart.png" style="width:30px;height:30px;">加入购物车</a> <br>
          </c:if>
         <div class="mask">
         <span>${oppo.opponame}
                <br>
...
<!--    网关部分  -->
   ...
   <div class="about">
    ...
    <div class="copy">© 2005 - 2017 OPPO 版权所有 粤ICP备08130115号-1 联系方式：4001-666-888  
     ...
     <span>关注我们:</span>
     <ul class="image">
           <li class="weibo"><a href="#"><img src="images/weibo.png" style="width: 45px;height: 45px;"></a> </li>
